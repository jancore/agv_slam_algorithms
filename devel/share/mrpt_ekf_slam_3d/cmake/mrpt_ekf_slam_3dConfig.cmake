...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrpt_ekf_slam_3d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smarlogy/catkin_ws/src/mrpt_slam/mrpt_ekf_slam_3d/${idir}'.  ${_report}")
    endif()
