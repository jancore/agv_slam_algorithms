...
class ObservationRangeBeacon {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.sensed_data.forEach((val) => {
      bufferOffset = SingleRangeBeaconObservation.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObservationRangeBeacon(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.sensed_data[i] = SingleRangeBeaconObservation.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 12 * object.sensed_data.length;
    return length + 84;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObservationRangeBeacon(null);
    ...
    if (msg.sensed_data !== undefined) {
      ...
      for (let i = 0; i < resolved.sensed_data.length; ++i) {
        resolved.sensed_data[i] = SingleRangeBeaconObservation.Resolve(msg.sensed_data[i]);
      }
    }
    else {
...
module.exports = ObservationRangeBeacon;
