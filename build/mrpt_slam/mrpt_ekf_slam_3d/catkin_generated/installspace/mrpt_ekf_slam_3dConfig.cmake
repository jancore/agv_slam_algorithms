...
if("FALSE" STREQUAL "TRUE")
  set(mrpt_ekf_slam_3d_SOURCE_PREFIX /home/smarlogy/catkin_ws/src/mrpt_slam/mrpt_ekf_slam_3d)
  set(mrpt_ekf_slam_3d_DEVEL_PREFIX /home/smarlogy/catkin_ws/devel)
  ...
  set(mrpt_ekf_slam_3d_INSTALL_PREFIX /home/smarlogy/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrpt_ekf_slam_3d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smarlogy/catkin_ws/install/${idir}'.  ${_report}")
    endif()
